...
Así, el nuevo problema de optimización consistirá en encontrar el hiperplano de separación definido por \( \beta \) y \( \beta_0 \), que minimice \eqref{eq: caso no separable función a minimizar}. Al hiperplano resultante se le denomina hiperplano de separación de margen flexible (Soft margin). La manera de obtener el hiperplano de separación es análoga al caso separable, por lo que los pasos siguientes son similares a los de la sección anterior.
